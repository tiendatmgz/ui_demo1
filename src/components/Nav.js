...
const NavTop = () => {
    return (
        <div className="nav_top p-5 h-32 w-full fixed top-0 left-0">
            <div className="w-full h-full border border-white flex">
                ...
                <div className='flex justify-between w-full'>
                    ...
                    <a href='/' className='h-full flex gap-2 items-center justify-center px-5'>
                        ...
                        <span className='bg-white text-black w-8 aspect-square flex justify-center items-center rounded-full'><i className="fa-solid fa-arrow-right"></i></span>
                        <></>
                    </a>
                </div>
            </div>
...
const NavLeft = () => {
    ...
    return (
        <div className="nav_left p-5 w-32 fixed " style={{ height: `${windownheight}px` }}>
